...
import { YStack, XStack, Text, Sheet, Separator } from 'tamagui'
import { Check, Minus, Plus, Ticket } from '@tamagui/lucide-icons'
...
export function MCPaymentSheet({ open, onOpenChange, showTitle, date, time, price }: MCPaymentSheetProps) {
  ...
  return (
    <Sheet modal open={open} onOpenChange={handleClose} snapPointsMode="fit" dismissOnSnapToBottom>
      <Sheet.Overlay backgroundColor="rgba(0,0,0,0.5)" />
      <Sheet.Frame backgroundColor="$white" borderTopLeftRadius={24} borderTopRightRadius={24} padding="$5">
